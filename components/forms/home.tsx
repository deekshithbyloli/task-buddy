    ...
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <Switch
          ...
          className="bg-gray-200 border-gray-300 data-[state=checked]:bg-blue-600 transition-all w-12 h-6 rounded-full relative"
        >
          <span
            className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full shadow-md transform transition-all ${
              viewMode === "board" ? "translate-x-6" : ""
            }`}
          />
        </Switch>
        <span className="flex items-center gap-2 text-gray-600 text-sm md:text-base">
